...
export default function BinSponsorEmissaoCartoesPage() {
  const cardTypes = [
    {
      ...
      description:
        "Emita cartões de crédito com limites flexíveis e funcionalidades avançadas para seus clientes.",
    },
    {
      icon: Wallet,
      title: "Cartões de Débito",
      description:
        "Cartões de débito conectados diretamente às contas dos usuários com transações em tempo real.",
    },
    {
      icon: Smartphone,
      title: "Cartões Pré-pagos",
      description:
        "Soluções de cartões pré-pagos ideais para controle de gastos e programas de benefícios.",
    },
    {
      icon: Users,
      title: "Cartões Múltiplos",
      description:
        "Cartões que funcionam como crédito e débito, oferecendo máxima flexibilidade aos usuários.",
    },
  ];
  ...
  const features = [
    {
      ...
      description:
        "Tenha seu próprio BIN (Bank Identification Number) certificado pelas principais bandeiras internacionais.",
    },
    {
      icon: Zap,
      title: "Emissão Instantânea",
      description:
        "Emita cartões virtuais instantaneamente e cartões físicos com produção e entrega expressa.",
    },
    {
      icon: Settings,
      title: "Personalização Total",
      description:
        "Customize design, funcionalidades, limites e regras de negócio conforme sua necessidade.",
    },
    {
      icon: Globe,
      title: "Aceitação Global",
      description:
        "Cartões aceitos mundialmente através das redes Visa, Mastercard e outras bandeiras parceiras.",
    },
    {
      icon: CreditCard,
      title: "Gestão Completa",
      description:
        "Plataforma completa para gerenciar todo o ciclo de vida dos cartões emitidos.",
    },
    {
      icon: Smartphone,
      title: "Carteira Digital",
      description:
        "Integração nativa com Apple Pay, Google Pay e Samsung Pay para pagamentos contactless.",
    },
  ];
  ...
  const benefits = [
    {
      ...
      description:
        "Gere receita através de anuidades, taxas de intercâmbio e serviços premium dos cartões.",
      metric: "Nova fonte de receita",
    },
    {
      title: "Controle Total",
      description:
        "Tenha controle completo sobre políticas, limites, aprovações e funcionalidades dos cartões.",
      metric: "100% personalizado",
    },
    {
      title: "Lançamento Rápido",
      description:
        "Do planejamento ao lançamento em tempo recorde com nossa plataforma white-label.",
  ...
  const processSteps = [
    {
      ...
      description:
        "Análise do seu negócio e definição da melhor estratégia para seu programa de cartões.",
    },
    {
      step: "02",
      title: "Certificação BIN",
      description:
        "Processo de obtenção e certificação do seu BIN junto às bandeiras internacionais.",
    },
    {
      step: "03",
      title: "Desenvolvimento e Design",
      description:
        "Criação do design dos cartões e desenvolvimento das funcionalidades específicas.",
    },
    {
      step: "04",
      title: "Homologação e Testes",
      description:
        "Testes completos de funcionalidade, segurança e integração antes do lançamento.",
    },
    {
      step: "05",
      title: "Produção e Lançamento",
      description:
        "Início da produção dos cartões físicos e ativação do programa para seus clientes.",
    },
  ];
  ...
  return (
    <main>
      {/* Hero Section */}
      <section
        className="relative flex items-center justify-center w-full overflow-hidden bg-hero"
      ...
      >
        ...
        >
          ...
          >
            BIN Sponsor e <span className="no-gradient">Emissão</span> de
            Cartões
          </motion.h1>
        ...
        <div className="container mx-auto px-4 md:px-6 relative">
          ...
          >
            ...
            <p className="text-lg text-gradient-hero max-w-3xl mx-auto">
              ...
              desde crédito tradicional até soluções inovadoras de cartões
              múltiplos.
            </p>
          </motion.div>
              ...
              >
                ...
                {index > 0 && (
                  <div className="absolute right-4 top-4 z-10">
                    <span className="bg-[var(--color-primary)] text-[var(--color-dark-green)] text-xs font-bold px-3 py-1 rounded-full shadow-lg border border-[var(--color-primary)]/40">
                      EM BREVE
                    </span>
                  </div>
                )}
      ...
      <section className="py-20 bg-horizontal">
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            ...
            <p className="text-lg text-gradient-hero max-w-3xl mx-auto">
              Nossa plataforma oferece todos os recursos necessários para operar
              um programa de cartões completo e competitivo no mercado.
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gradient-hero mb-8">
                ...
                Personalize cores, logotipos, texturas e até mesmo materiais
                especiais.
              </p>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/80">
                      Materiais de alta qualidade incluindo metal, madeira e
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/80">
                      Cartões virtuais com números temporários para maior
                      segurança online.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/80">
                      NFC integrado para pagamentos por aproximação e
                      compatibilidade total com carteiras digitais.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 bg-horizontal">
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            ...
            <p className="text-lg text-gradient-hero max-w-3xl mx-auto">
              Tenha seu próprio programa de cartões e capitalize sobre as
              oportunidades do mercado financeiro em crescimento.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-solutions">
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            ...
            <p className="text-lg text-gradient-hero max-w-3xl mx-auto">
              Um processo estruturado e eficiente para levar seu programa de
              cartões do conceito ao mercado no menor tempo possível.
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gradient-hero mb-8">
                Plataforma completa para gerenciar todos os aspectos do seu
                programa de cartões, desde a emissão até o atendimento ao
                cliente.
              </p>
      ...
      <section className="py-20 bg-solutions">
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            <h2 className="text-3xl md:text-5xl  title-gradient-hero mb-6">
              Números que <span className="no-gradient">Comprovam</span> Nossa
              Excelência
            </h2>
          </motion.div>
