...
export const MenuDock: React.FC<MenuDockProps> = ({ 
  ...
  return (
    <nav
      className={cn(
        'relative inline-flex items-center rounded-xl bg-[var(--color-dark-green)] border border-[var(--color-primary)] shadow-lg backdrop-blur-sm',
    ...
    >
        ...
        return (
          <button
            ...
            className={cn(
              ...
              'hover:bg-[var(--color-primary)]/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)]',
              styles.item,
              isActive && 'text-[var(--color-primary)]',
              !isActive && 'text-[var(--color-foreground)] hover:text-[var(--color-primary)]'
            )}
      ...
      {showLabels && orientation === 'horizontal' && (
        <div
          className={cn(
            'absolute bottom-2 h-0.5 bg-[var(--color-primary)] rounded-full transition-all duration-300 ease-out',
      ...
      {(!showLabels || orientation === 'vertical') && (
        <div
          className={cn(
            'absolute bg-[var(--color-primary)] rounded-full transition-all duration-300',
